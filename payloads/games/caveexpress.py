#!/usr/bin/env python3
"""
RaspyJack Payload -- CaveExpress
==================================
Author: 7h30th3r0n3

Physics-based 2D platformer on CardputerZero LCD.
...
FB_SIZE = W * H * 2
DISPLAY_NUM = ":97"
GAME_BIN = "/usr/games/caveexpress"
...
def main():
    ...
    _show_msg("CAVEEXPRESS", "Starting...", (100, 200, 255))
    ...
    game = subprocess.Popen([GAME_BIN, "-windowed"], env=env, stdout=subprocess.DEVNULL, stderr=subprocess.DEVNULL)
    time.sleep(3)
    ...
    try:
        ...
        subprocess.run(["pkill", "-9", "caveexpress"], capture_output=True)
